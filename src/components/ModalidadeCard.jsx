      ...
      <div className="relative flex h-full flex-col gap-5 p-6 pt-8">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="rounded-2xl bg-slate-900/95 p-3 text-red-400 shadow-lg shadow-red-500/10">
              <Icon className="h-5 w-5" />
            </div>
            <div>
              <p className="text-[11px] uppercase tracking-[0.2em] text-slate-500">Modalidade</p>
              <h2 className="mt-1 text-2xl font-semibold text-white font-serif">{modalidade.name}</h2>
            </div>
          </div>
          <span className="rounded-full border border-slate-800 bg-slate-900/90 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-300">{modalidade.badge}</span>
        </div>
